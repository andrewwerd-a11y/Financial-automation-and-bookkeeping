...
export function ImportsPage({ activeBusinessId }: { activeBusinessId: string }) {
  ...
  const submitSingle = async () => {
    ...
    try {
      setError('');
      const result = await uploadCsv(file, { templateId: templateId || undefined, saveTemplateName: saveTemplateName || undefined, businessId: activeBusinessId || undefined });
  ...
  const submitBulk = async () => {
    ...
    try {
      setError('');
      const result = await uploadCsvBulk(bulkFiles, templateId || undefined, activeBusinessId || undefined);
